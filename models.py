...
class Client:
    def __init__(self, id: str, name: str, phone: str, plan_type: str, value: float, 
                 ...
                 payment_status: str = "pendente", payment_date: Optional[str] = None):
        self.id = id
        self.name = name
        ...
        self.payment_status = payment_status  # 'pendente', 'pago', 'atrasado'
        self.payment_date = payment_date  # Data do pagamento (YYYY-MM-DD)
    ...
    def should_send_reminder(self) -> bool:
        """Verifica se deve enviar lembrete (não envia se já foi pago)"""
